...
const SECTIONS: Section[] = [
  {
    ...
    blocks: [
      {
        type: "p",
        body: "De rol die Legal Vacatures onder de AVG vervult, hangt af van de dienst waarvan u gebruik maakt:",
      },
      {
        type: "ul-labeled",
        items: [
          {
            ...
            body: "Legal Vacatures treedt op als zelfstandig verwerkingsverantwoordelijke voor de verwerking van persoonsgegevens van kandidaten die wij actief werven, voordragen en bemiddelen, en voor de kandidaten in onze talentpool.",
          },
          {
            label:
          ...
          },
          {
            ...
            body: "Voor de verwerking van gegevens van websitebezoekers en inschrijvingen in de eigen talentpool van Legal Vacatures, treedt Legal Vacatures op als zelfstandig verwerkingsverantwoordelijke.",
          },
        ],
      },
      {
        type: "p",
        body: "Legal Vacatures en werkgevers die het vacatureplatform gebruiken, leggen hun onderlinge afspraken over de verwerking van sollicitatiegegevens vast via de Algemene Voorwaarden en, waar nodig, een aanvullende verwerkersovereenkomst.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        body: "Sollicitaties die via het vacatureplatform binnenkomen, worden opgeslagen in onze eigen beveiligde database. Legal Vacatures neemt passende technische en organisatorische maatregelen, waaronder:",
      },
      {
        type: "ul",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        body: "Legal Vacatures maakt geen gebruik van volledig geautomatiseerde besluitvorming met rechtsgevolgen voor betrokkenen. Eventuele matching- of sorteerfunctionaliteiten binnen het vacatureplatform zijn uitsluitend ondersteunend en resulteren niet in geautomatiseerde beslissingen over uw sollicitatie.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        body: "Bij een (vermoeden van een) datalek verzoeken wij u dit direct te melden via het in artikel 17 genoemde e-mailadres. Legal Vacatures beoordeelt ieder incident en doet, indien vereist, binnen 72 uur melding bij de Autoriteit Persoonsgegevens en, waar nodig, bij de betrokken personen.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "p",
        body: "Legal Vacatures kan dit privacybeleid wijzigen. De meest actuele versie is altijd beschikbaar op onze website en binnen het vacatureplatform. Bij ingrijpende wijzigingen worden gebruikers actief geïnformeerd.",
      },
    ],
  },
  {
